...
const Categories = ({ data, pageName, d }) => {
                    ...
                    <div class="">
                        ...
                        <div>
                            {data[0].children.map(cat_data => (
                                <div>
                                    <div class="text-blue-500 text-xl">{cat_data.name}</div>
                                    <div class="grid grid-cols-4 p-5">{cat_data.children.map(ch_data => (
                                        <div class="mb-9">
                                            <Image className="mx-auto mb-3 hover:-translate-y-3 ease-in transition-all duration-200" src={LoadImages(ch_data.images)} height={150} width={150} />
